...
function SessionTopBar({
  ...
  const participantCount = session ? (session.participant ? 2 : 1) : 0;
        ...
        {isHost && session?.status === "active" && (
          <>
            ...
            >
              {isEnding ? (
                <>
                  <SpinnerIcon size={11} color={T.red} />
                  Ending…
                </>
              ) : (
                <>
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            Unable to connect to the video call. Check your network and try
            rejoining.
          </div>
          <button
            style={{
              ...
              fontFamily: "'DM Sans', sans-serif",
              cursor: "pointer",
              boxShadow: "0 2px 8px rgba(24,104,219,0.3)",
            }}
...
/* ─── Status bar ─────────────────────────────────────────────────────────────── */
function StatusBar({ isRunning, lastResult, session }) {
  return (
    <div
      style={{
        height: 24,
                        ...
                        >
                          <div
                            style={{
                              ...
                              color: T.blue,
                              background: T.blueTint,
                              outline: "1px solid rgba(24,104,219,0.2)",
                            }}
                          >
                            <CodeFileIcon />
                            solution.
                          ...
                          {lastResult && !isRunning && (
                            ...
                            >
                              <Badge
                                color={lastResult.success ? T.green : T.red}
                                bg={
                                  lastResult.success ? T.greenTint : T.redTint
                                }
                                border={
                                  lastResult.success
                                    ? T.greenBorder
